...
// newContext creates and returns a Context initialized for a process.
// The returned Context embeds the provided Go context, engine, and pid,
// initializes an empty children safemap, and sets a safe default getInboxCount
// function (returns -1). Other fields such as sender, receiver, message and
// parentCtx are left nil and should be set by the caller as needed.
